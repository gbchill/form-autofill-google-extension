# ASU Tennis Challenge Form AutoFiller

A Chrome browser extension specifically designed for ASU Tennis Club Challenge Forms that automatically fills the exact form fields within seconds of the form opening.
...
3. Fill in your ASU Tennis Challenge Form information:
   - **Full Name**: Your complete name (for the "Name" field)
   - **Practice Days**: Select 2 days from **ONLY Monday/Wednesday/Thursday** for 6:30-8:00pm practice
   - **Challenge Days**: Select 2 days from **ONLY Monday/Wednesday/Thursday** for challenges (warmed up by 6:30pm)
   - **Challenge Type**: Choose Challenge/Battle/Team/No
   - **Individual Challenge Target**: Name of player you want to challenge or battle (for individual challenges)
   - **Team Partner Name**: Your partner's name (for team doubles/mixed challenges)

   **Note**: The form only allows Monday, Wednesday, and Thursday - no other days are available.
...
- **Popup Interface**: Professional UI for configuration and manual controls
...
## ASU Tennis Challenge Form Mapping

The extension is specifically configured for the ASU Tennis Challenge Form fields:

| Form Field | Extension Fills |
|------------|-----------------|
| **Name** | Your full name |
| **Attendance: Select two days you will attend practice** | Your selected practice days |
| **Challenge Attendance: Select two days you can participate** | Your selected challenge days |
| **Would you like to challenge, battle, or team?** | Your challenge type preference |
| **Who would you like to challenge/battle OR partner name** | Automatically selects appropriate name based on challenge type |

### Exact Form Fields Supported:
- ✅ **Name** (text field)
- ✅ **Practice attendance checkboxes** - ONLY Monday/Wednesday/Thursday available
- ✅ **Challenge attendance checkboxes** - ONLY Monday/Wednesday/Thursday available
- ✅ **Challenge type radio buttons** (Challenge/Battle/Team/No)
- ✅ **Individual challenge target or team partner name** (text field)

**Important**: The ASU Tennis form only offers Monday, Wednesday, and Thursday as options. No other days (Tue/Fri/Sat/Sun) are available in the actual form.
